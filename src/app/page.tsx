      ...
      <div className="mx-auto max-w-3xl px-6 py-14">
        ...
        <header className="flex items-start justify-between">
          ...
          <nav className="flex items-center gap-5 text-sm text-neutral-400">
            ...
            <a href="https://linkedin.com/in/oronila" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-200 transition" aria-label="LinkedIn">
              {/* LinkedIn icon */}
            ...
            <a href="https://x.com/oronila" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-200 transition" aria-label="X (Twitter)">
              {/* X icon */}
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
